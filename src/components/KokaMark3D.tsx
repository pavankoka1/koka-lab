...
export function KokaMark3D() {
  ...
  if (reduced) {
    return (
      <div className="fixed right-5 top-5 z-[60] sm:right-8 sm:top-8">
        <a
          href="/"
          className="group flex items-center gap-2 rounded-2xl border border-[var(--stroke)] bg-[var(--bg-secondary)]/90 px-4 py-2.5 font-mono text-sm font-semibold tracking-[0.2em] text-[var(--text-primary)] shadow-[0_0_40px_var(--glow)] backdrop-blur-md transition-colors hover:border-[var(--accent-blue)]/30"
  ...
  return (
    <div className="fixed right-4 top-4 z-[60] sm:right-8 sm:top-8">
      <a
        href="/"
        className="group block rounded-2xl border border-[var(--stroke)] bg-[var(--bg-secondary)]/80 p-1 shadow-[0_0_48px_var(--glow)] backdrop-blur-md transition-[border-color,box-shadow] duration-300 hover:border-[var(--accent-blue)]/30 hover:shadow-[0_0_64px_rgba(0,180,255,0.10)]"
        aria-label={`${site.name} — home`}
      >
